...
| aws | [bench-ec2](aws/bench-ec2/SKILL.md) | `"1.0.0"` | Manage the i8g.8xlarge AWS EC2 instance used to benchmark diskgraph (launch, status, stop, start, terminate, ssh-config, ssm, bootstrap). |
