...
| aws | [billing-investigate](aws/billing-investigate/SKILL.md) | `"1.0.0"` | Investigate AWS cost surges or anomalies on the Kumo SaaS account using the CUR (Cost and Usage Report) in Athena. Read-only — never mutates AWS resources. |
