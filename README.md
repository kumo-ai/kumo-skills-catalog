...
| collab | [annotate-iterate](collab/annotate-iterate/SKILL.md) | `"0.1.0-alpha"` | Iterate on a written artifact (doc, design spec, RFC, runbook) using inline `annotate:` markers as a review channel. |
